...
<div class="row botao-novo">
	<div class="col-md-12">
		...
		<a href="index.php?acao=<?php echo $pagina ?>&funcao=novo"  type="button" class="btn btn-secondary">Novo Tipo de OS</a>
	</div>
</div>
	...
	<div class="col-md-6 col-sm-12">
		...
		<div class="float-right mr-4">
			<form id="frm" class="form-inline my-2 my-lg-0" method="post">
				...
				<input class="form-control form-control-sm mr-sm-2" type="search" placeholder="Tipo" aria-label="Search" id="txtbuscar" name="txtbuscar">
		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"><?php if(@$_GET['funcao'] == 'editar'){
					...
					$res = $pdo->query("select * from tipo where id = '$id_reg'");
					$dados = $res->fetchAll(PDO::FETCH_ASSOC);
					$nome = $dados[0]['nome'];



					echo 'Edição de Tipos de OS';
				}else{
					$nome_botao = 'Salvar';
					echo 'Cadastro de Tipos de OS';
				} ?>
			</h5>
		...
		<div class="modal-body">
			<form method="post">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="nome" placeholder="Nome do Tipo de OS" name="nome" value="<?php echo @$nome ?>" required>
				</div>
